...
console.log(`New Evens Array: `, evensArr); 
...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24, 67, 43, 2];
// Do not edit the code above.
...
if (myFavoriteNumbers.length<7){
  ...
  console.log(`There are indeed enough elements in this array:`, myFavoriteNumbers.length); 
  console.log(someNum); 
  console.log(`---------------------`); 
}
